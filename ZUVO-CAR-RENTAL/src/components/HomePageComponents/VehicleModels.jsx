...
import "F:/RP - ZUVO/ZUVO-CAR-RENTAL/src/styles/HomePageStyles/VehicleModel.css";
      ...
      <div className="flex items-center justify-center flex-col h-screen bg-[#D6BFC4] p-8">
        ...
        <Swiper
          breakpoints={{
            ...
            1024: { slidesPerView: 4, spaceBetween: 20 }, // Adjusted to 3 slides per view
          }}
          freeMode={true}
        ...
        >
          {VehicleM.map((item, index) => (
            <SwiperSlide key={index}>
              <motion.div
                whileHover={{ scale: 1.1 }} // Moves only the hovered card
